/*
  BubbleBackpack.cpp - A new classless library for The Bubble Backpacks (to circumvent the compiling hold error).
  Includes the "Hello Arduino" example.
  By TinkerTroniks.com
  Created by Serg, June 30, 2015.
  Released into the public domain.
  https://github.com/sergioser/BubbleBackpack
*/
...
void loop() {
  ...
  setDisplayIntensity(1); // takes any value from 0 - 15, 15 is the brightest.
...
//Initiates data pins connected to the display
void constructor(int clkPin, int csPin, int dinPin) {
  _csPin = csPin;
  _clkPin = clkPin;
  _dinPin = dinPin;
...
void setupDisplay(int numberOfDigits, int numDisplays) {
